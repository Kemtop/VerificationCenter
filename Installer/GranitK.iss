...
AppId={{8C856DDA-0922-41C4-B4F8-C20BE2829312}
AppName={#MyAppName}
...
OutputDir=.
OutputBaseFilename=GranitK_setup
;Password=1
Compression=lzma
LicenseFile=.\InstallerFiles\license.rtf
;Compression=lzma2/ultra
SolidCompression=yes
SetupIconFile=.\InstallerFiles\app.ico
...
Name: "Crypt"; Description: "Установка системы шифрования"
Name: "Crk"; Description: "Развертывание ЦРК"

[Components]
Name: "Crypt"; Description: "Система криптозащиты информации"; Types: Crypt; Flags: exclusive
Name: "Crk"; Description: "Центр регистрации ключей"; Types: Crk; Flags: exclusive
Name: "KeyGen"; Description: "Генератор ключей"; Types: custom Crk Crypt; Flags: fixed
