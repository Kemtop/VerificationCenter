...
const  unsigned long long Hash3411::A[64] = {
...
const unsigned char Hash3411::Sbox[256]={
...
const unsigned char Hash3411::Tau[64]={
...
unsigned char Hash3411::C[12][64] = {
{
...
//[1]-А.2 Пример 2
const unsigned char Hash3411::Message[TEST_VECTORS][MAX_MESSAGE_LENGTH] = {
	{
...
//[0]-ГОСТ 34.11-2012 Приложение А Пример 1
//[1]-А.2 Пример 2
const unsigned char Hash3411::Hash_512[TEST_VECTORS][64] = {
	{
...
//[0]-ГОСТ 34.11-2012 Приложение А Пример 1
//[1]-А.2 Пример 2
const unsigned char Hash3411::Hash_256[TEST_VECTORS][32] = {
	{
...
const  int Hash3411::MessageLength[TEST_VECTORS] = {
		504, 576
};



void Hash3411::AddModulo512(const unsigned char *a,const unsigned char *b,unsigned char *c)
{
	int i = 0, t = 0;
...
void Hash3411::AddXor512(const void *a,const void *b,void *c)
{
	int i = 0;
...
void Hash3411::S(unsigned char *state)
{
	int i = 0;
...
void Hash3411::L(unsigned char *state)
{
...
void Hash3411::P(unsigned char *state)
{
	int i = 0;
	unsigned char t[64] = {};
...
void Hash3411::KeySchedule(unsigned char *K,int i)
{
	AddXor512(K,C[i],K);
...
void Hash3411::E(unsigned char *K,const unsigned char *m, unsigned char *state)
{
	int i = 0;
...
void Hash3411::g_N(const unsigned char *N,unsigned char *h,const unsigned char *m)
{
...
void Hash3411::hash_X(unsigned char *IV,const unsigned char *message,unsigned long long length,unsigned char *out)
{
...
void Hash3411::hash_512(const unsigned char *message,unsigned long long length,unsigned char *out)
{
	unsigned char IV[64] =
	{
			0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00,
...
void Hash3411::hash_256(const unsigned char *message,unsigned long long length,unsigned char *out)
{
	unsigned char IV[64] =
	{
