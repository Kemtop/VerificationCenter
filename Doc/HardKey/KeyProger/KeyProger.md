...
<p>
4. Копируем серийный номер продукта "BCBC9-MXCY5-WAGMI-J20TF-C6F40". Очищаем поле ввода, содержащее 5 групп нулей. Вставляем скопированную строку. Нажимаем - «SetSerial».<br>
