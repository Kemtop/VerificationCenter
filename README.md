<h1 align="center">Система криптографической защиты информации «Гранит-VII»</h1>
...
<p align="left">
Проект предназначен в ознакомительных и демонстрационных целях. Автору известны существующие ошибки и недоработки.
