...
<hr>
<p align="left">
<strong>ManagedLib</strong>-проекты на .NET 6. Реализована обвёртка для библиотеки шифрования, тесты. Ведется дальнейший перенос логики из Qt на Net.
</p>
<p align="left">
...
<p align="left">
<strong>Native</strong>-каталог содержит библиотеку криптографии и Qt приложения. Ведется дальнейшая чистка решения.
</p>
<hr>
<p align="left">
  Решение состоит из:
